class password {
    constructor() {
      ...
      FunnyPassword(){
        let arr= ["Password","Incorrect","Kalu","IForgot","Secret","Boli","MyName",
        "Chetan_Hacker","Nothing","Khubsurat Padosan", "Motu",
        "maiNahiBataunga","Sorry","1$perminute","Love you later on"]
